...
exports.run = async (client, message, args) => {
    ...
    if (!shopCommon.isWholePositiveNumber(amount) || target === undefined) {
        return message.reply("Sorry, Either the target is not a valid user, or I cannot deduct an amount of simbits that is either negative or not a whole number! Remember `?deduct 10 @Bevers222#2642`")
    }
